...
public class LocationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TemplatesPackage.Literals.LOCATION__NAME_POSITION);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(TemplatesPackage.Literals.LOCATION__INVARIANT,
				 TemplatesFactory.eINSTANCE.createInvariant()));

		newChildDescriptors.add
			(createChildParameter
				(TemplatesPackage.Literals.LOCATION__NAME_POSITION,
				 VisualsFactory.eINSTANCE.createPoint()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == VisualsPackage.Literals.PLANAR_ELEMENT__POSITION ||
			childFeature == TemplatesPackage.Literals.LOCATION__NAME_POSITION;
