...
import org.muml.uppaal.templates.Guard;
import org.muml.uppaal.templates.Invariant;
...
import org.muml.uppaal.templates.Update;
...
public class TemplatesPackageImpl extends EPackageImpl implements TemplatesPackage {
	 ...
	 */
	@Override
	public EReference getLocation_NamePosition() {
	 ...
	 */
	@Override
	public EReference getUpdate_Expression() {
	...
	public void createPackageContents() {
		...
		createEReference(locationEClass, LOCATION__NAME_POSITION);
		...
		createEReference(updateEClass, UPDATE__EXPRESSION);
	...
	public void initializePackageContents() {
		...
		synchronizationEClass.getESuperTypes().add(theVisualsPackage.getPlanarElement());
		selectionEClass.getESuperTypes().add(theDeclarationsPackage.getVariableContainer());
		selectionEClass.getESuperTypes().add(theVisualsPackage.getPlanarElement());
		guardEClass.getESuperTypes().add(theVisualsPackage.getPlanarElement());
		invariantEClass.getESuperTypes().add(theVisualsPackage.getPlanarElement());
		updateEClass.getESuperTypes().add(theVisualsPackage.getPlanarElement());
		...
		initEReference(getLocation_Invariant(), this.getInvariant(), null, "invariant", null, 0, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLocation_NamePosition(), theVisualsPackage.getPoint(), null, "namePosition", null, 0, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEdge_Guard(), this.getGuard(), null, "guard", null, 0, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEdge_Update(), this.getUpdate(), null, "update", null, 0, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGuard_Expression(), theExpressionsPackage.getExpression(), null, "expression", null, 1, 1, Guard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(invariantEClass, Invariant.class, "Invariant", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getInvariant_Expression(), theExpressionsPackage.getExpression(), null, "expression", null, 1, 1, Invariant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(updateEClass, Update.class, "Update", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUpdate_Expression(), theExpressionsPackage.getExpression(), null, "expression", null, 1, -1, Update.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
