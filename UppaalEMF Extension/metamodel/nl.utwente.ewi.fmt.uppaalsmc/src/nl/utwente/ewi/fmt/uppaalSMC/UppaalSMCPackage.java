...
public interface UppaalSMCPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Probability Position</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CHANCE_EDGE__PROBABILITY_POSITION = TemplatesPackage.EDGE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CHANCE_EDGE_FEATURE_COUNT = TemplatesPackage.EDGE_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the containment reference '{@link nl.utwente.ewi.fmt.uppaalSMC.ChanceEdge#getProbabilityPosition <em>Probability Position</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Probability Position</em>'.
	 * @see nl.utwente.ewi.fmt.uppaalSMC.ChanceEdge#getProbabilityPosition()
	 * @see #getChanceEdge()
	 * @generated
	 */
	EReference getChanceEdge_ProbabilityPosition();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Probability Position</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CHANCE_EDGE__PROBABILITY_POSITION = eINSTANCE.getChanceEdge_ProbabilityPosition();
