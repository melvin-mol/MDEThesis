...
public class UppaalSMCPackageImpl extends EPackageImpl implements UppaalSMCPackage {
	 ...
	 * @generated
	 */
	public EReference getChanceEdge_ProbabilityPosition() {
		return (EReference)chanceEdgeEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(chanceEdgeEClass, CHANCE_EDGE__PROBABILITY_POSITION);
	...
	public void initializePackageContents() {
		...
		initEReference(getChanceEdge_ProbabilityPosition(), theVisualsPackage.getPoint(), null, "probabilityPosition", null, 0, 1, ChanceEdge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
