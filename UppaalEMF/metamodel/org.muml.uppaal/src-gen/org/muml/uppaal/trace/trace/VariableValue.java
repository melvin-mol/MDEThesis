 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.uppaal.trace.trace.VariableValue#getFirstNamedElementReference <em>First Named Element Reference</em>}</li>
 *   <li>{@link org.muml.uppaal.trace.trace.VariableValue#getSecondNamedElementReference <em>Second Named Element Reference</em>}</li>
 *   <li>{@link org.muml.uppaal.trace.trace.VariableValue#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.muml.uppaal.trace.trace.VariableValue#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see org.muml.uppaal.trace.trace.TracePackage#getVariableValue()
 * @model
 * @generated
 */
public interface VariableValue extends EObject
{
   ...
   * @see org.muml.uppaal.trace.trace.TracePackage#getVariableValue_FirstNamedElementReference()
  ...
  /**
   * Sets the value of the '{@link org.muml.uppaal.trace.trace.VariableValue#getFirstNamedElementReference <em>First Named Element Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.muml.uppaal.trace.trace.TracePackage#getVariableValue_SecondNamedElementReference()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.muml.uppaal.trace.trace.VariableValue#getSecondNamedElementReference <em>Second Named Element Reference</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The literals are from the enumeration {@link org.muml.uppaal.trace.trace.CompareOperator}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.muml.uppaal.trace.trace.TracePackage#getVariableValue_Operator()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.muml.uppaal.trace.trace.VariableValue#getOperator <em>Operator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setValue(int)
   * @see org.muml.uppaal.trace.trace.TracePackage#getVariableValue_Value()
   * @model
   * @generated
   */
  int getValue();
  ...
  /**
   * Sets the value of the '{@link org.muml.uppaal.trace.trace.VariableValue#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
