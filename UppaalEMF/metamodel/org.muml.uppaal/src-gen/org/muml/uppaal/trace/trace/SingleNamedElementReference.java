 ...
 * </p>
 * <ul>
 *   <li>{@link org.muml.uppaal.trace.trace.SingleNamedElementReference#getNamedElement <em>Named Element</em>}</li>
 *   <li>{@link org.muml.uppaal.trace.trace.SingleNamedElementReference#getIndexes <em>Indexes</em>}</li>
 * </ul>
 *
 * @see org.muml.uppaal.trace.trace.TracePackage#getSingleNamedElementReference()
 * @model
 * @generated
 */
public interface SingleNamedElementReference extends EObject
{
   ...
   * @see org.muml.uppaal.trace.trace.TracePackage#getSingleNamedElementReference_NamedElement()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.muml.uppaal.trace.trace.SingleNamedElementReference#getNamedElement <em>Named Element</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.muml.uppaal.trace.trace.TracePackage#getSingleNamedElementReference_Indexes()
   * @model unique="false"
   * @generated
   */
