 ...
 *   <li>{@link org.muml.uppaal.templates.impl.LocationImpl#getNamePosition <em>Name Position</em>}</li>
...
public class LocationImpl extends NamedElementImpl implements Location {
	...
	/**
	 * The cached value of the '{@link #getNamePosition() <em>Name Position</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getNamePosition()
	 * @generated
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInvariant(Invariant newInvariant, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNamePosition(Point newNamePosition, NotificationChain msgs) {
		Point oldNamePosition = namePosition;
		namePosition = newNamePosition;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemplatesPackage.LOCATION__NAME_POSITION, oldNamePosition, newNamePosition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 */
	@Override
	public void setNamePosition(Point newNamePosition) {
		if (newNamePosition != namePosition) {
			NotificationChain msgs = null;
			if (namePosition != null)
				msgs = ((InternalEObject)namePosition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemplatesPackage.LOCATION__NAME_POSITION, null, msgs);
			if (newNamePosition != null)
				msgs = ((InternalEObject)newNamePosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemplatesPackage.LOCATION__NAME_POSITION, null, msgs);
			msgs = basicSetNamePosition(newNamePosition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemplatesPackage.LOCATION__NAME_POSITION, newNamePosition, newNamePosition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case TemplatesPackage.LOCATION__NAME_POSITION:
				return basicSetNamePosition(null, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TemplatesPackage.LOCATION__INVARIANT:
				...
				return;
			case TemplatesPackage.LOCATION__NAME_POSITION:
				setNamePosition((Point)newValue);
				return;
			case TemplatesPackage.LOCATION__LOCATION_TIME_KIND:
